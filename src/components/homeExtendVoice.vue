  ...
  <div class="wordWrapper">
    ...
    <div class="testType" id="testType" style="display: none;">
      <div class="topBtn clearfix">
        <div class="typeBtn1" onclick="hideTestType('testType')">认字母<span>▼</span></div>
      </div>
      <div class="testList clearfix">
        <ul class="leftNav">
          <li><span></span>字母拼读</li>
          <li><span></span>音节拼读</li>
          <li><span></span>单词拼读</li>
        </ul>
        <ul class="rightNav">
          <li><span></span>认字母</li>
          <li class="tested"><span></span>单个字母</li>
          <li><span></span>元音组合</li>
          <li><span></span>其他组合</li>
          <li><span></span>双音节</li>
          <li><span></span>两到三个音节</li>
          <li><span></span>三个音节</li>
          <li><span></span>三到四个字母</li>
          <li><span></span>五到六个字母</li>
          <li><span></span>六个字母</li>
        </ul>
      </div>
    </div>
    <!--内容顶部导航-->
    <ul class="menus clearfix">
      <li class="typeBtn" onclick="showTestType('testType')">五到六个字母<span>▼</span></li>
    ...
    <ul class="passPoint clearfix">
      <li class="beforeStudy">
        <h3>学前测试</h3>
        <div class="testBtn" style="display:none">开始测试</div>
        <div class="score" style="display:block">90分</div>
      </li>
      <!--已经测试了的 -->
      <li class="unlocked hasTest">
        <h4>第一关</h4>
        <div class="locked">80</div>
