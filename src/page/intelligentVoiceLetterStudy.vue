    ...
    <div class="centerBox" v-loading="loading">
      ...
      <div class="mainCon">
        ...
        <div class="inputBox"
          ...
          <div class="laba" id="laba" @click="fnAudioPalyer(thisWord.letter_url)"></div>
        ...
        <!--中文词义-->
        <div class="mean" v-show="showWord">字母{{thisWord.letter.toUpperCase()}}</div>
      </div>
      <!--底部内容-->
      <div class="botInfo">
        <!--<span>引擎档位： 6</span>-->
...
<script>
  export default {
    ...
    data() {
      return {
        ...
        thisWord: {
          "id": 32,
          "letter": "y",
          "letter_url": "\\UploadeFile\\Video\\y.wav",
          "more": null
        }, // 当前单词
        wordList: [],
    ...
    computed: {
      // 拼接左上角学习的教材标题
      thisVersionName() {
        return '智能语音 - 字母拼读 - ' + this.$route.query.typeName;
      }
    },
    mounted() {
      this.fnStudyTime();
