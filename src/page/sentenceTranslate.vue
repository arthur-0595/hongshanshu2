      ...
      <div class="centerBox">
        ...
        <div class="mainCon">
          <div class="sentenceBox">
            <!--正确的句子，答错 显示，答对不显示-->
            <div class="correctSentence" style="visibility: hidden;">Would you like a pie ?</div>

            <div class="mySentence clearfix" >
              <!--一开始要写单词的格子 upWord表示填写了的单词  red表示填写错误的单词-->
              <ul class="lineBox clearfix" style="display: block;">
                <li class="upWord">Would</li>
                <li class="upWord">you</li>
                <li class="upWord">like</li>
                <li class="upWord">a</li>
                <li class="upWord">pie</li>
                <li class="punctuation">?</li>
              </ul>
              <span class="brush" style="display: none;"></span>
              <span class="laba" style="display: block;"></span>
            </div>
          </div>
          <!--记忆强度-->
          <div class="totalBar">
          ...
          <div class="bottomBox">
            <!--中文意思-->
            <div class="meaning" style="display:block">你想要来一个馅饼吗?</div>
            <!--一开始打乱的单词-->
            <div class="wordsBox clearfix">
              <ul class="randomWords clearfix"  style="display:none">
                <li>you</li>
                <li>Would</li>
                <li>pie</li>
                <li>like</li>
              ...
              <!--一开始是哭脸 答对 下一题forword 答错 practice 练习-->
              <span class="face forword"></span>
              <div class="overtime" style="display: none;"><span></span>超时了，再快点儿！</div>
            </div>
          </div>
        </div>
        <!--底部内容-->
