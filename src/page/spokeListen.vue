	...
	<div class="box-wrapper">
		...
		<div class="centerBox">
			...
			<div class="mainCon clearfix">
				<div class="leftCon">
					<p class="enSentence">{{listenData[listenIndex].sentence}}</p>
					<p class="chSentence" v-if="isMean">{{listenData[listenIndex].sentence_mean}}</p>
